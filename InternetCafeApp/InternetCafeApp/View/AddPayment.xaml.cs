...
namespace InternetCafeApp.View
{
    ...
    public sealed partial class AddPayment : Page
    {
        ...
        private void btnSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Int32 txtTotalAmountInt = 0;
                Int32 txtRecievedAmountInt = 0;
                if (txtTotalAmount.Text.ToString().Length > 0)
                    txtTotalAmountInt =  Int32.Parse(txtTotalAmount.Text);
                if (txtRecievedAmount.Text.ToString().Length > 0)
                    txtRecievedAmountInt = Int32.Parse(txtRecievedAmount.Text);

                _vm.UpdateRecordnRoomPaymentDone(_vm.SelectedItemRecordInt.oirecord, txtTotalAmountInt, txtRecievedAmountInt);
